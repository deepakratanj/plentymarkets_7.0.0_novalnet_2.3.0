 ...
 */
class NovalnetOnlineBankTransferPaymentMethod extends PaymentMethodService
{
    /**
    ...
    {
       if ($this->configRepository->get('Novalnet.novalnet_online_bank_transfer_payment_active') == 'true') {
        
        $active_payment_allowed_country = true;
        if ($allowed_country = $this->configRepository->get('Novalnet.novalnet_online_bank_transfer_allowed_country')) {
        ...
        $minimum_amount = trim($this->configRepository->get('Novalnet.novalnet_online_bank_transfer_minimum_order_amount'));
        ...
        $maximum_amount = trim($this->configRepository->get('Novalnet.novalnet_online_bank_transfer_maximum_order_amount'));
    ...
    {   
        return $this->paymentHelper->getCustomizedTranslatedText('paymentmethod_novalnet_online_bank_transfer');
    }
    ...
    {
       $logoUrl = $this->configRepository->get('Novalnet.novalnet_online_bank_transfer_payment_logo');
        if($logoUrl == 'images/onlinebanktransfer.png'){
            /** @var Application $app */
            $app = pluginApp(Application::class);
            $logoUrl = $app->getUrlPath('novalnet') .'/images/onlinebanktransfer.png';
        } 
        return $logoUrl;
    }
    ...
    {
        return $this->paymentHelper->getCustomizedTranslatedText('paymentmethod_novalnet_online_bank_transfer_payment_description');
    }
